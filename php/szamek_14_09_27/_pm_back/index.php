...
<html>
    ...
    <body>
        ...
        <h1>ProMedia Developer - domy Twoich marzeń</h1>
        <br>
        <h2>Witaj na stronie internetowej firmy ProMedia Developer</h2>
        
        <p class="main">

        <br> 
        Dowiesz się z tutaj wszystkiego o działalności naszej firmy. <br>
        Możesz tutaj także zapoznać się z naszą ofertą. <br>
        <br>
        <br>
        <br>
