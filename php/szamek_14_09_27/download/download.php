 ...
 *   
 *   The icon images are designed by Mark James 
...
//
$_CONFIG['hidden_dirs'] = array("gallery");
...
//
$_CONFIG['hidden_files'] = array("download.php", "header.php", "smile.php",  "smile.pdf", ".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd");
...
//
$_CONFIG['users'] = array(array("miki", "123heh", "admin"));
...
<div id="frame">
<?php
if(EncodeExplorer::getConfig('show_top') == false)
{
?>
