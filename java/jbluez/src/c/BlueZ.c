...
void throwException(JNIEnv *env, char *msg)
{
	...
	exception_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/BlueZException");
...
JNIEXPORT jint JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciOpenDevice
  (JNIEnv *env, jobject obj, jint hciID)
{
	...
	if (dd < 0)
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciOpenDevice: HCI Device open failed");

	return dd;
}

JNIEXPORT void JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciCloseDevice
...
JNIEXPORT jint JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciCreateConnection
  (JNIEnv *env, jobject obj, jint dd, jstring bdaddr_jstr, jint ptype, jint clkoffset, jshort rswitch, jint timeOut)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciCreateConnection: Unable to create connection");
		return -1;
	}
...
JNIEXPORT void JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciDisconnect
  (JNIEnv *env, jobject obj, jint dd, jint handle, jshort reason, jint timeOut)
{
	/* Disconnect */
	if (hci_disconnect(dd, handle, 0x13, timeOut) < 0)
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciDisconnect: Unable to disconnect");
  ...
  (JNIEnv *env, jobject obj, jint dd, jint length, jint max_num_rsp, jlong flags)
{
	...
	if (num_rsp < 0)
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciInquiry: Inquiry failed");
		return 0;
	}
	...
	iid_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/InquiryInfoDevice");
	iid_con_id = (*env)->GetMethodID(env, iid_cls, "<init>", "(Lcom/appliancestudio/jbluez/BTAddress;SSSSSSI)V");
	ba_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/BTAddress");
...
JNIEXPORT jobject JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciDevInfo
  (JNIEnv *env, jobject obj, jint hciID)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciDevInfo: Failed to get device info");
		return 0;
	}
	...
	ds_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/HCIDeviceStats");
	...
	df_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/HCIFeatures");
	...
	bda_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/BTAddress");
	...
	di_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/HCIDeviceInfo");
...
JNIEXPORT jobject JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciDevBTAddress
  (JNIEnv *env, jobject obj, jint hciID)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciDevBTAddress: Unable to get Bluetooth address for device");
		return 0;
	}
...
JNIEXPORT jint JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciDeviceID
  (JNIEnv *env, jobject obj, jstring bdaddr_jstr)
{
	...
	if (devID < 0)
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciDeviceID: Unable to get device ID");
...
JNIEXPORT jstring JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciLocalName
  (JNIEnv *env, jobject obj, jint dd, jint timeOut)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciLocalName: Unable to read local name");
		return 0;
	}
...
JNIEXPORT jstring JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciRemoteName
  (JNIEnv *env, jobject obj, jint dd, jstring bdaddr_jstr, jint timeOut)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciRemoteName: Unable to read remote name");
		return 0;
	}
...
JNIEXPORT jobject JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciReadRemoteFeatures
  (JNIEnv *env, jobject obj, jint dd, jint handle, jint timeOut)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciReadRemoteFeatures: Unable to read remote features");
		return 0;
	}
	...
	features_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/HCIFeatures");
...
JNIEXPORT jobject JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciReadRemoteVersion
  (JNIEnv *env, jobject obj, jint dd, jint handle, jint timeOut)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciReadRemoteVersion: Unable to read remote version");
		return 0;
	}
	...
	ver_cls = (*env)->FindClass(env, "com/appliancestudio/jbluez/HCIVersion");
...
JNIEXPORT jobject JNICALL Java_com_appliancestudio_jbluez_BlueZ_hciReadLocalVersion
  (JNIEnv *env, jobject obj, jint dd, jint timeOut)
{
	...
	{
		throwException(env, "Java_com_appliancestudio_jbluez_BlueZ_hciReadLocalVersion: Unable to read local version");
		return 0;
	}
