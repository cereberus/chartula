...
public class Rotation_v3 extends JFrame implements ActionListener {
	private JTextField topField = new JTextField("top", 20);
	private JLabel bottomLabel = new JLabel(
			"Czas dzialania programu w sekundach:");
	...
	private double hoursLine = 0;
	private double minutesLine = 0;
...
//			for (int i = 0; i < 60; i++) {
//				g.setColor(Color.ORANGE);
//				hoursLine = Math.toRadians(360 * i / 60) - Math.PI / 2;
////				System.out.println(Math.toRadians(360 * i / 60) + " - " +  Math.PI / 2);
//				int q = (int) (260 * Math.cos(hoursLine));
//				int p = (int) (260 * Math.sin(hoursLine));
//				g.drawLine(300, 300, 300 + q, 300 + p);
//				
//				
//				g.setColor(Color.BLUE);
//				hoursLine = Math.toRadians(360 * i / 60) - Math.PI / 2;
////				System.out.println(Math.toRadians(360 * i / 60) + " - " +  Math.PI / 2);
//				int r = (int) (220 * Math.cos(hoursLine));
//				int s = (int) (220 * Math.sin(hoursLine));
//				g.drawLine(300, 300, 300 + r, 300 + s);
//			}
