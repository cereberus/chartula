/* Propositional Tableaux Implementation; from "First-Order Logic and Automated Theorem Proving" by Melvin Fitting; minor modifications by Dorota Leszczyñska-Jasion */
:- op(140,fy,neg).
