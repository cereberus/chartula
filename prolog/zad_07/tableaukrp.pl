/* A Tableau Implementation for first-order logic; from "First-Order Logic and Automated Theorem Proving" by Melvin Fitting; minor modifications by Dorota Leszczyñska-Jasion */
...
yes(Qdepth) :-
	write('Podana formu³a posiada dowód (w systemie TA) o Q-g³êbokoœci '),
	write(Qdepth),
	write('.'),nl.

no(Qdepth) :-
	write('Podana formu³a nie posiada dowodu (w systemie TA) o Q-g³êbokoœci '),
	write(Qdepth),
	write('.'),nl,
	write('Wypróbuj wiêksz¹ Q-g³êbokoœæ.').
